...
std::vector<Move >King::getLegalMoves(const Board& board)
{
	...
	//castles
	if (this->color == Color::white && board.whiteCastleLeft == true && board.board[7][0].first == PieceCode::whiteRook)
	{
	...
	if (this->color == Color::white && board.whiteCastleRight == true)
	{
		if (!(board.attackedWhite[7][4] || board.attackedWhite[7][5] || board.attackedWhite[7][6]) && board.board[7][7].first == PieceCode::whiteRook)
		{
	...
	if (this->color == Color::black && board.blackCastleLeft == true)
	{
		if (!(board.attackedBlack[0][4] || board.attackedBlack[0][3] || board.attackedBlack[0][2]) && board.board[0][0].first == PieceCode::blackRook)
		{
			bool flag = true;
			for (int i = 1; i <= 3; i++)
	...
	if (this->color == Color::black && board.blackCastleRight == true && board.board[0][7].first == PieceCode::blackRook)
	{
